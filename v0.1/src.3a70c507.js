...
"use strict";require("./styles.scss");var t=e(require("airtable"));function e(t){return t&&t.__esModule?t:{default:t}}var i=new t.default({apiKey:"key10KeIIPJpM8npJ"}).base("appFHShc770eIgtu9");function n(t){var e=[];t.forEach(function(t){e.push(a(t))});new TL.Timeline("app",{events:e})}function a(t){var e=t.get("Position Date").split("-"),i={year:+e[0],month:+e[1],day:+e[2]},n=t.get("IIIF Endpoint")?"".concat(t.get("IIIF Endpoint"),"/square/500,/0/default.jpg"):"";return{unique_id:t.get("ID"),text:{headline:t.get("Caption Title"),text:"<p>".concat(t.get("Caption"),'</p><p class="object-title">').concat(t.get("Object Title"),'</p><p class="object-creator">').concat(t.get("Object Creator"),'</p><p class="contributing-institution">').concat(t.get("Contributing Institution"),"</p>")},start_date:i,display_date:t.get("Display Date"),media:{url:t.get("Image URL"),link:t.get("Repository URL"),thumbnail:n}}}i("Timeline Objects").select({view:"Grid view",filterByFormula:"{Status} = 'Published'"}).firstPage().then(function(t){n(t)});
},{"./styles.scss":"I4sy","airtable":"XHil"}]},{},["Focm"], null)
//# sourceMappingURL=src.3a70c507.js.map